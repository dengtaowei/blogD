...
| | |
|---|---|
| **前置** | [`03-configfs-assembly.md`](03-configfs-assembly.md) 或 [`04-create-kernel-map.md`](04-create-kernel-map.md) |
| **本文** | 结构体、回调、映射表（调试时查阅） |
| **下一步** | [`06-udc-core-bind.md`](06-udc-core-bind.md) |

> **STM32MP157** / Linux 5.4 / `deferred_fb_serial` + `acm.0`。系列索引：[`README.md`](README.md)。

---

## 1. 与 02 架构的关系

全栈四层模型见 [`02-architecture-overview.md`](02-architecture-overview.md) §2。  
...
**`usb_gadget`：** UDC 硬件抽象（端点、速度、pullup）。示例 UDC：`49000000.usb-otg`。
