...
> **关联**：[Gadget 子系统概览](/analysis/kernel/usb/gadget-subsystem) · [Configfs 组装分析](/analysis/kernel/usb/gadget-configfs-assembly) · [Gadget 内核参考](/analysis/kernel/usb/gadget-kernel-reference) · [UDC bind 分析](/analysis/kernel/usb/gadget-udc-core-bind) · [USB 2.0 枚举流程](/analysis/kernel/usb/usb-enumeration)（Host 侧对照）· [枚举与两轮 Probe](/analysis/kernel/usb/enumeration-and-probe)  
