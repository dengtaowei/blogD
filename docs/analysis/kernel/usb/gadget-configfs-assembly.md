---
homeTag: USB · Gadget
homeTitle: Gadget configfs 组装分析
...
- [5. 提交组装结果](#5-提交组装结果--echo-udc--udc)
- [6. Host 枚举](#6-host-枚举--运行时激活非-configfs-组装)
- [7. 脚本 → 结构体速查表](#7-脚本--结构体-速查表)
- [8. 与 legacy composite 的对应](#8-与-legacy-composite-的对应)
- [9. 总图](#9-总图)
- [10. 源码索引](#10-源码索引)
...
configfs 组装的是**静态描述符与 function 对象**；Host 插线后（协议层见 [USB 2.0 枚举流程](/analysis/kernel/usb/usb-enumeration)）：
